<?php
$json_data = file_get_contents("http://192.168.1.21:8000/getipsdb");

$data = json_decode($json_data, true);

echo "<H1 style='text-align: center;'>" . "IP addresses Previously Reported as Active " . "</H1>";
echo "<H3 style='text-align: center;'>" . "Collected from Database" . "</H3>";
echo "<br>";
